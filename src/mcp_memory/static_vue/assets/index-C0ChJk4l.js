...
#endif`,$2="gl_FragColor = linearToOutputTexel( gl_FragColor );",X2=`vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
void main() {
	...
	`}class H_ extends mi{constructor(e=1,n={}){super(e,e,n),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},s=[i,i,i,i,i,i];this.texture=new F_(s),this._setTextureOptions(n),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,n){this.texture.type=n.type,this.texture.colorSpace=n.colorSpace,this.texture.generateMipmaps=n.generateMipmaps,this.texture.minFilter=n.minFilter,this.texture.magFilter=n.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),l=new jt(a,c),u=new z_(-1,1,1,-1,0,1);let d=null,f=null,h=!1,g,_=null,p=[],m=!1;this.setSize=function(x,E){r.setSize(x,E),o.setSize(x,E);for(let y=0;y<p.length;y++){const C=p[y];C.setSize&&C.setSize(x,E)}},this.setEffects=function(x){p=x,m=p.length>0&&p[0].isRenderPass===!0;const E=r.width,y=r.height;for(let C=0;C<p.length;C++){const A=p[C];A.setSize&&A.setSize(E,y)}},this.begin=function(x,E){if(h||x.toneMapping===pi&&p.length===0)return!1;if(_=E,E!==null){const y=E.width,C=E.height;(r.width!==y||r.height!==C)&&this.setSize(y,C)}return m===!1&&x.setRenderTarget(r),g=x.toneMapping,x.toneMapping=pi,!0},this.hasRenderPass=function(){return m},this.end=function(x,E){x.toneMapping=g,h=!0;let y=r,C=o;for(let A=0;A<p.length;A++){const L=p[A];if(L.enabled!==!1&&(L.render(x,C,y,E),L.needsSwap!==!1)){const S=y;y=C,C=S}}if(d!==x.outputColorSpace||f!==x.toneMapping){d=x.outputColorSpace,f=x.toneMapping,c.defines={},ot.getTransfer(d)===_t&&(c.defines.SRGB_TRANSFER="");const A=dI[f];A&&(c.defines[A]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=y.texture,x.setRenderTarget(_),x.render(l,u),_=null,h=!1},this.isCompositing=function(){return h},this.dispose=function(){r.dispose(),o.dispose(),a.dispose(),c.dispose()}}const G_=new cn,uf=new Mo(1,1),W_=new C_,$_=new D3,X_=new F_,Tp=[],Ap=[],Cp=new Float32Array(16),Rp=new Float32Array(9),Pp=new Float32Array(4);function Pr(t,e,n){const i=t[0];if(i<=0||i>0)return t;const s=e*n;let r=Tp[s];if(r===void 0&&(r=new Float32Array(s),Tp[s]=r),e!==0){i.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=n,t[o].toArray(r,a)}return r}function kt(t,e){if(t.length!==e.length)return!1;for(let n=0,i=t.length;n<i;n++)if(t[n]!==e[n])return!1;return!0}function zt(t,e){for(let n=0,i=e.length;n<i;n++)t[n]=e[n]}function zl(t,e){let n=Ap[e];n===void 0&&(n=new Int32Array(e),Ap[e]=n);for(let i=0;i!==e;++i)n[i]=t.allocateTextureUnit();return n}function pI(t,e){const n=this.cache;n[0]!==e&&(t.uniform1f(this.addr,e),n[0]=e)}function mI(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2f(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(kt(n,e))return;t.uniform2fv(this.addr,e),zt(n,e)}}function gI(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3f(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else if(e.r!==void 0)(n[0]!==e.r||n[1]!==e.g||n[2]!==e.b)&&(t.uniform3f(this.addr,e.r,e.g,e.b),n[0]=e.r,n[1]=e.g,n[2]=e.b);else{if(kt(n,e))return;t.uniform3fv(this.addr,e),zt(n,e)}}function _I(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4f(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(kt(n,e))return;t.uniform4fv(this.addr,e),zt(n,e)}}function vI(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(kt(n,e))return;t.uniformMatrix2fv(this.addr,!1,e),zt(n,e)}else{if(kt(n,i))return;Pp.set(i),t.uniformMatrix2fv(this.addr,!1,Pp),zt(n,i)}}function xI(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(kt(n,e))return;t.uniformMatrix3fv(this.addr,!1,e),zt(n,e)}else{if(kt(n,i))return;Rp.set(i),t.uniformMatrix3fv(this.addr,!1,Rp),zt(n,i)}}function yI(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(kt(n,e))return;t.uniformMatrix4fv(this.addr,!1,e),zt(n,e)}else{if(kt(n,i))return;Cp.set(i),t.uniformMatrix4fv(this.addr,!1,Cp),zt(n,i)}}function SI(t,e){const n=this.cache;n[0]!==e&&(t.uniform1i(this.addr,e),n[0]=e)}function MI(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2i(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(kt(n,e))return;t.uniform2iv(this.addr,e),zt(n,e)}}function bI(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3i(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else{if(kt(n,e))return;t.uniform3iv(this.addr,e),zt(n,e)}}function EI(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4i(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(kt(n,e))return;t.uniform4iv(this.addr,e),zt(n,e)}}function wI(t,e){const n=this.cache;n[0]!==e&&(t.uniform1ui(this.addr,e),n[0]=e)}function TI(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2ui(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(kt(n,e))return;t.uniform2uiv(this.addr,e),zt(n,e)}}function AI(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3ui(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else{if(kt(n,e))return;t.uniform3uiv(this.addr,e),zt(n,e)}}function CI(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4ui(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(kt(n,e))return;t.uniform4uiv(this.addr,e),zt(n,e)}}function RI(t,e,n){const i=this.cache,s=n.allocateTextureUnit();i[0]!==s&&(t.uniform1i(this.addr,s),i[0]=s);let r;this.type===t.SAMPLER_2D_SHADOW?(uf.compareFunction=n.isReversedDepthBuffer()?Jf:Zf,r=uf):r=G_,n.setTexture2D(e||r,s)}function PI(t,e,n){const i=this.cache,s=n.allocateTextureUnit();i[0]!==s&&(t.uniform1i(this.addr,s),i[0]=s),n.setTexture3D(e||$_,s)}function LI(t,e,n){const i=this.cache,s=n.allocateTextureUnit();i[0]!==s&&(t.uniform1i(this.addr,s),i[0]=s),n.setTextureCube(e||X_,s)}function DI(t,e,n){const i=this.cache,s=n.allocateTextureUnit();i[0]!==s&&(t.uniform1i(this.addr,s),i[0]=s),n.setTexture2DArray(e||W_,s)}function II(t){switch(t){case 5126:return pI;case 35664:return mI;case 35665:return gI;case 35666:return _I;case 35674:return vI;case 35675:return xI;case 35676:return yI;case 5124:case 35670:return SI;case 35667:case 35671:return MI;case 35668:case 35672:return bI;case 35669:case 35673:return EI;case 5125:return wI;case 36294:return TI;case 36295:return AI;case 36296:return CI;case 35678:case 36198:case 36298:case 36306:case 35682:return RI;case 35679:case 36299:case 36307:return PI;case 35680:case 36300:case 36308:case 36293:return LI;case 36289:case 36303:case 36311:case 36292:return DI}}function NI(t,e){t.uniform1fv(this.addr,e)}function UI(t,e){const n=Pr(e,this.size,2);t.uniform2fv(this.addr,n)}function FI(t,e){const n=Pr(e,this.size,3);t.uniform3fv(this.addr,n)}function OI(t,e){const n=Pr(e,this.size,4);t.uniform4fv(this.addr,n)}function BI(t,e){const n=Pr(e,this.size,4);t.uniformMatrix2fv(this.addr,!1,n)}function kI(t,e){const n=Pr(e,this.size,9);t.uniformMatrix3fv(this.addr,!1,n)}function zI(t,e){const n=Pr(e,this.size,16);t.uniformMatrix4fv(this.addr,!1,n)}function VI(t,e){t.uniform1iv(this.addr,e)}function HI(t,e){t.uniform2iv(this.addr,e)}function GI(t,e){t.uniform3iv(this.addr,e)}function WI(t,e){t.uniform4iv(this.addr,e)}function $I(t,e){t.uniform1uiv(this.addr,e)}function XI(t,e){t.uniform2uiv(this.addr,e)}function qI(t,e){t.uniform3uiv(this.addr,e)}function YI(t,e){t.uniform4uiv(this.addr,e)}function jI(t,e,n){const i=this.cache,s=e.length,r=zl(n,s);kt(i,r)||(t.uniform1iv(this.addr,r),zt(i,r));let o;this.type===t.SAMPLER_2D_SHADOW?o=uf:o=G_;for(let a=0;a!==s;++a)n.setTexture2D(e[a]||o,r[a])}function KI(t,e,n){const i=this.cache,s=e.length,r=zl(n,s);kt(i,r)||(t.uniform1iv(this.addr,r),zt(i,r));for(let o=0;o!==s;++o)n.setTexture3D(e[o]||$_,r[o])}function ZI(t,e,n){const i=this.cache,s=e.length,r=zl(n,s);kt(i,r)||(t.uniform1iv(this.addr,r),zt(i,r));for(let o=0;o!==s;++o)n.setTextureCube(e[o]||X_,r[o])}function JI(t,e,n){const i=this.cache,s=e.length,r=zl(n,s);kt(i,r)||(t.uniform1iv(this.addr,r),zt(i,r));for(let o=0;o!==s;++o)n.setTexture2DArray(e[o]||W_,r[o])}function QI(t){switch(t){case 5126:return NI;case 35664:return UI;case 35665:return FI;case 35666:return OI;case 35674:return BI;case 35675:return kI;case 35676:return zI;case 5124:case 35670:return VI;case 35667:case 35671:return HI;case 35668:case 35672:return GI;case 35669:case 35673:return WI;case 5125:return $I;case 36294:return XI;case 36295:return qI;case 36296:return YI;case 35678:case 36198:case 36298:case 36306:case 35682:return jI;case 35679:case 36299:case 36307:return KI;case 35680:case 36300:case 36308:case 36293:return ZI;case 36289:case 36303:case 36311:case 36292:return JI}}class eN{constructor(e,n,i){this.id=e,this.addr=i,this.cache=[],this.type=n.type,this.setValue=II(n.type)}}class tN{constructor(e,n,i){this.id=e,this.addr=i,this.cache=[],this.type=n.type,this.size=n.size,this.setValue=QI(n.type)}}class nN{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,n,i){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(e,n[a.id],i)}}}const Gc=/(\w+)(\])?(\[|\.)?/g;function Lp(t,e){t.seq.push(e),t.map[e.id]=e}function iN(t,e,n){const i=t.name,s=i.length;for(Gc.lastIndex=0;;){const r=Gc.exec(i),o=Gc.lastIndex;let a=r[1];const c=r[2]==="]",l=r[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===s){Lp(n,l===void 0?new eN(a,t,e):new tN(a,t,e));break}else{let d=n.map[a];d===void 0&&(d=new nN(a),Lp(n,d)),n=d}}}class Oa{constructor(e,n){this.seq=[],this.map={};const i=e.getProgramParameter(n,e.ACTIVE_UNIFORMS);for(let o=0;o<i;++o){const a=e.getActiveUniform(n,o),c=e.getUniformLocation(n,a.name);iN(a,c,this)}const s=[],r=[];for(const o of this.seq)o.type===e.SAMPLER_2D_SHADOW||o.type===e.SAMPLER_CUBE_SHADOW||o.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(o):r.push(o);s.length>0&&(this.seq=s.concat(r))}setValue(e,n,i,s){const r=this.map[n];r!==void 0&&r.setValue(e,i,s)}setOptional(e,n,i){const s=n[i];s!==void 0&&this.setValue(e,i,s)}static upload(e,n,i,s){for(let r=0,o=n.length;r!==o;++r){const a=n[r],c=i[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,s)}}static seqWithValue(e,n){const i=[];for(let s=0,r=e.length;s!==r;++s){const o=e[s];o.id in n&&i.push(o)}return i}}function Dp(t,e,n){const i=t.createShader(e);return t.shaderSource(i,n),t.compileShader(i),i}const sN=37297;let rN=0;function oN(t,e){const n=t.split(`
`),i=[],s=Math.max(e-6,0),r=Math.min(e+6,n.length);for(let o=s;o<r;o++){const a=o+1;i.push(`${a===e?">":" "} ${a}: ${n[o]}`)}return i.join(`
`)}const Ip=new Qe;function aN(t){ot._getMatrix(Ip,ot.workingColorSpace,t);const e=`mat3( ${Ip.elements.map(n=>n.toFixed(4))} )`;switch(ot.getTransfer(t)){case il:return[e,"LinearTransferOETF"];case _t:return[e,"sRGBTransferOETF"];default:return Xe("WebGLProgram: Unsupported color space: ",t),[e,"LinearTransferOETF"]}}function Np(t,e,n){const i=t.getShaderParameter(e,t.COMPILE_STATUS),r=(t.getShaderInfoLog(e)||"").trim();if(i&&r==="")return"";const o=/ERROR: 0:(\d+)/.exec(r);if(o){const a=parseInt(o[1]);return n.toUpperCase()+`

`+r+`

`+oN(t.getShaderSource(e),a)}else return r}function lN(t,e){const n=aN(e);return[`vec4 ${t}( vec4 value ) {`,`	return ${n[1]}( vec4( value.rgb * ${n[0]}, value.a ) );`,"}"].join(`
`)}const cN={[d_]:"Linear",[h_]:"Reinhard",[p_]:"Cineon",[m_]:"ACESFilmic",[__]:"AgX",[v_]:"Neutral",[g_]:"Custom"};function uN(t,e){const n=cN[e];return n===void 0?(Xe("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+t+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+t+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const Sa=new $;function fN(){ot.getLuminanceCoefficients(Sa);const t=Sa.x.toFixed(4),e=Sa.y.toFixed(4),n=Sa.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${t}, ${e}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
`)}function dN(t){return[t.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",t.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Kr).join(`
`)}function hN(t){const e=[];for(const n in t){const i=t[n];i!==!1&&e.push("#define "+n+" "+i)}return e.join(`
`)}function pN(t,e){const n={},i=t.getProgramParameter(e,t.ACTIVE_ATTRIBUTES);for(let s=0;s<i;s++){const r=t.getActiveAttrib(e,s),o=r.name;let a=1;r.type===t.FLOAT_MAT2&&(a=2),r.type===t.FLOAT_MAT3&&(a=3),r.type===t.FLOAT_MAT4&&(a=4),n[o]={type:r.type,location:t.getAttribLocation(e,o),locationSize:a}}return n}function Kr(t){return t!==""}function Up(t,e){const n=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return t.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,n).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Fp(t,e){return t.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const mN=/^[ \t]*#include +<([\w\d./]+)>/gm;function ff(t){return t.replace(mN,_N)}const gN=new Map;function _N(t,e){let n=tt[e];if(n===void 0){const i=gN.get(e);if(i!==void 0)n=tt[i],Xe('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return ff(n)}const vN=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Op(t){return t.replace(vN,xN)}function xN(t,e,n,i){let s="";for(let r=parseInt(e);r<parseInt(n);r++)s+=i.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Bp(t){let e=`precision ${t.precision} float;
...
#define LOW_PRECISION`),e}const yN={[Da]:"SHADOWMAP_TYPE_PCF",[Yr]:"SHADOWMAP_TYPE_VSM"};function SN(t){return yN[t.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const MN={[ks]:"ENVMAP_TYPE_CUBE",[yr]:"ENVMAP_TYPE_CUBE",[Ol]:"ENVMAP_TYPE_CUBE_UV"};function bN(t){return t.envMap===!1?"ENVMAP_TYPE_CUBE":MN[t.envMapMode]||"ENVMAP_TYPE_CUBE"}const EN={[yr]:"ENVMAP_MODE_REFRACTION"};function wN(t){return t.envMap===!1?"ENVMAP_MODE_REFLECTION":EN[t.envMapMode]||"ENVMAP_MODE_REFLECTION"}const TN={[f_]:"ENVMAP_BLENDING_MULTIPLY",[u3]:"ENVMAP_BLENDING_MIX",[f3]:"ENVMAP_BLENDING_ADD"};function AN(t){return t.envMap===!1?"ENVMAP_BLENDING_NONE":TN[t.combine]||"ENVMAP_BLENDING_NONE"}function CN(t){const e=t.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),7*16)),texelHeight:i,maxMip:n}}function RN(t,e,n,i){const s=t.getContext(),r=n.defines;let o=n.vertexShader,a=n.fragmentShader;const c=SN(n),l=bN(n),u=wN(n),d=AN(n),f=CN(n),h=dN(n),g=hN(r),_=s.createProgram();let p,m,x=n.glslVersion?"#version "+n.glslVersion+`
...
void main() {
    ...
    `,transparent:!0,vertexColors:!0,blending:_u,depthWrite:!1});f=new mp(L,D),u.add(f),s.value=A}function m(){if(!u)return;const A=60,L=[];for(let D=0;D<A;D++){const N=Math.random()*Math.PI*2,z=Math.acos(2*Math.random()-1),G=5+Math.random()*3,k=new $(G*Math.sin(z)*Math.cos(N),G*Math.sin(z)*Math.sin(N),G*Math.cos(z)),w=k.clone().multiplyScalar(.5+Math.random()*.3),T=Math.random()*Math.PI*2,V=Math.acos(2*Math.random()-1),X=5+Math.random()*3,re=new $(X*Math.sin(V)*Math.cos(T),X*Math.sin(V)*Math.sin(T),X*Math.cos(V)),pe=new i2(k,w,re).getPoints(8);L.push(...pe)}const S=new tn().setFromPoints(L),M=new N_({color:65345,transparent:!0,opacity:.15}),U=new K3(S,M);U.userData.isSynapse=!0,u.add(U),r.value=A,o.value=3}function x(A){var D,N,z;if(!u||!f)return;const L=A.memory_count||0,S=((D=A.tiered_breakdown)==null?void 0:D.storage)||0,M=((N=A.tiered_breakdown)==null?void 0:N.thinking)||0,U=((z=A.tiered_breakdown)==null?void 0:z.skill)||0;u.children.forEach(G=>{if(G.userData.region&&G instanceof jt){const k=G.material;let w=.5;switch(G.userData.region){case"storage":w=.3+S/Math.max(L,1)*.7;break;case"thinking":w=.3+M/Math.max(L,1)*.7;break;case"skill":w=.3+U/Math.max(L,1)*.7;break}k.opacity=w}})}function E(){if(!a||!c||!l||!u)return;d=requestAnimationFrame(E);const A=performance.now()*.001;u.rotation.y=A*.15,u.rotation.x=Math.sin(A*.3)*.1,f&&f.material instanceof Un&&(f.material.uniforms.uTime.value=A),l.render(a,c)}function y(){if(!n.value||!c||!l)return;const A=n.value.clientWidth,L=n.value.clientHeight;c.aspect=A/L,c.updateProjectionMatrix(),l.setSize(A,L)}function C(){d&&(cancelAnimationFrame(d),d=null),window.removeEventListener("resize",y),u&&(u.traverse(A=>{(A instanceof jt||A instanceof mp||A instanceof U_)&&(A.geometry&&A.geometry.dispose(),A.material&&(Array.isArray(A.material)?A.material.forEach(L=>L.dispose()):A.material.dispose()))}),a&&a.remove(u)),l&&(l.dispose(),l.forceContextLoss(),n.value&&l.domElement.parentNode===n.value&&n.value.removeChild(l.domElement)),a=null,c=null,l=null,u=null,f=null}return(A,L)=>(ue(),fe("div",aU,[v("div",{ref_key:"canvasRef",ref:n,class:"canvas-wrapper"},null,512),v("div",lU,[v("div",cU,[v("div",uU,[L[0]||(L[0]=v("span",{class:"stat-label"},"神经元",-1)),v("span",fU,te(s.value),1)]),v("div",dU,[L[1]||(L[1]=v("span",{class:"stat-label"},"突触连接",-1)),v("span",hU,te(r.value),1)]),v("div",pU,[L[2]||(L[2]=v("span",{class:"stat-label"},"活跃区域",-1)),v("span",mU,te(o.value),1)])])]),i.value?(ue(),fe("div",gU,[...L[3]||(L[3]=[v("div",{class:"loading-spinner"},null,-1),v("p",null,"初始化大脑模型...",-1)])])):et("",!0)]))}}),vU=Cn(_U,[["__scopeId","data-v-3cc56395"]]),xU={class:"app-container"},yU={class:"main-sidebar"},SU={class:"sidebar-header"},MU={class:"status-label"},bU={class:"sidebar-nav"},EU=["onClick"],wU={class:"nav-icon"},TU={class:"nav-text"},AU={class:"sidebar-actions"},CU={class:"action-grid"},RU=["disabled"],PU={class:"btn-text"},LU=["disabled"],DU={class:"btn-text"},IU={class:"viewport"},NU={class:"top-bar"},UU={class:"view-title"},FU={class:"top-stats"},OU={class:"view-content"},BU={key:0,class:"dashboard-layout"},kU={class:"visual-section card-glass"},zU={class:"graph-section card-glass"},VU={class:"logs-section card-glass"},HU={key:1,class:"full-view card-glass"},GU={key:2,class:"centered-view card-glass"},WU={key:3,class:"full-view card-glass"},$U={key:4,class:"split-view"},XU={key:5,class:"full-view card-glass"},qU={key:6,class:"centered-view card-glass"},YU={key:7,class:"full-view card-glass"},jU={key:0,class:"detail-panel card-glass"},KU={class:"modal-title"},ZU={class:"modal-content"},JU={class:"info-row"},QU={class:"info-section"},eF={class:"meta-grid"},tF={class:"meta-box"},nF={class:"val"},iF={class:"meta-box"},sF={class:"val"},rF={class:"meta-box"},oF={class:"val"},aF=xn({__name:"App",setup(t){const e=Wi(),{graphData:n,isLoading:i,evolutionStatus:s,stats:r}=wr(e),o=[{id:"overview",label:"概览",icon:"📊"},{id:"memory-list",label:"记忆列表",icon:"📋"},{id:"write",label:"写入",icon:"✏️"},{id:"tiered",label:"三层记忆",icon:"🧠"},{id:"brain",label:"AI大脑",icon:"🤖"},{id:"llm",label:"LLM交互",icon:"🤖"},{id:"evolution",label:"进化配置",icon:"⚙️"},{id:"merge",label:"合并链",icon:"🔗"}],a=we("overview"),c=we(null),l=we(null),u=we(!1),d=we(!1),f=we(!1),h=Uv(null),g=we({}),_=Et(()=>{var k,w;return((k=s.value)==null?void 0:k.enabled)&&((w=s.value)==null?void 0:w.running)}),p=Et(()=>{const k=o.find(w=>w.id===a.value);return(k==null?void 0:k.label)||"概览"});qn(async()=>{e.addLog("初始化系统...","info");try{await e.fetchStats(),e.addLog("加载统计数据完成","success"),await e.fetchGraph(),e.addLog("加载记忆图谱完成","success"),await e.fetchEvolutionStatus(),e.addLog("加载进化状态完成","success")}catch(k){e.addLog("初始化失败: "+k.message,"error")}});function m(k){e.addLog(`点击节点: ${k.label||k.id}`,"info"),l.value=k.id,a.value!=="merge"&&(a.value="merge")}function x(k){c.value=k,e.addLog(`选择记忆: ${k.title}`,"info")}function E(k){e.addLog(`新记忆已写入: ${k}`,"success"),e.fetchStats(),e.fetchGraph()}function y(){e.addLog("记忆已保存","success"),M(),e.fetchStats(),e.fetchGraph()}function C(k){e.addLog(`记忆已删除: ${k}`,"success"),M(),c.value=null,e.fetchStats(),e.fetchGraph()}function A(k){e.addLog(`点击合并链节点: ${k.title}`,"info")}function L(){c.value=null}function S(){c.value&&(h.value=dT,g.value={visible:!0,memory:c.value},f.value=!0)}function M(){f.value=!1,h.value=null,g.value={}}function U(){c.value&&(l.value=c.value.id,a.value="merge",L())}async function D(){u.value=!0,e.addLog("开始重建图谱...","info");try{await pn.rebuildGraph(),await e.fetchGraph(),e.addLog("图谱重建完成","success")}catch(k){e.addLog("图谱重建失败: "+k.message,"error")}finally{u.value=!1}}async function N(){d.value=!0,e.addLog("触发反思任务...","info");try{await e.reflectMemory(),e.addLog("反思任务已触发","success"),await e.fetchEvolutionStatus()}catch(k){e.addLog("触发反思失败: "+k.message,"error")}finally{d.value=!1}}async function z(){e.addLog("刷新所有数据...","info");try{await Promise.all([e.fetchStats(),e.fetchGraph(),e.fetchEvolutionStatus()]),e.addLog("数据刷新完成","success")}catch(k){e.addLog("数据刷新失败: "+k.message,"error")}}function G(k){return{storage:"存储记忆",thinking:"思维记忆",skill:"技能记忆"}[k||""]||k||"未知"}return(k,w)=>(ue(),fe("div",xU,[w[10]||(w[10]=v("div",{class:"scanline"},null,-1)),v("aside",yU,[v("div",SU,[w[3]||(w[3]=v("h1",{class:"logo"},[pr("MEMORY"),v("span",null,"CORE")],-1)),v("div",{class:pt(["status-badge",{"is-active":_.value}])},[w[2]||(w[2]=v("span",{class:"status-dot"},null,-1)),v("span",MU,te(_.value?"在线":"待机"),1)],2)]),v("nav",bU,[(ue(),fe(mt,null,Ot(o,T=>v("button",{key:T.id,class:pt(["nav-item",{active:a.value===T.id}]),onClick:V=>a.value=T.id},[v("span",wU,te(T.icon),1),v("span",TU,te(T.label),1)],10,EU)),64))]),v("div",AU,[v("div",CU,[v("button",{onClick:D,disabled:u.value},[v("span",PU,te(u.value?"同步中...":"重建图谱"),1)],8,RU),v("button",{onClick:N,disabled:d.value},[v("span",DU,te(d.value?"思考中...":"反思"),1)],8,LU)]),v("button",{class:"primary-btn",onClick:z},"刷新数据")])]),v("main",IU,[v("header",NU,[v("div",UU,[w[4]||(w[4]=v("span",{class:"path"},"系统 /",-1)),pr(" "+te(p.value),1)]),v("div",FU,[yt(kw)])]),v("div",{class:pt(["content-viewport",{"panel-active":f.value}])},[v("div",OU,[a.value==="overview"?(ue(),fe("div",BU,[v("div",kU,[yt(vU,{stats:be(r)},null,8,["stats"])]),v("div",zU,[yt(w1,{"graph-data":be(n),"is-loading":be(i),onNodeClick:m},null,8,["graph-data","is-loading"])]),v("div",VU,[yt(Sw)])])):a.value==="memory-list"?(ue(),fe("div",HU,[yt(mw,{onMemorySelect:x})])):a.value==="write"?(ue(),fe("div",GU,[yt(tT,{onWritten:E})])):a.value==="tiered"?(ue(),fe("div",WU,[yt(zT,{onMemorySelect:x})])):a.value==="brain"?(ue(),fe("div",$U,[yt($R,{class:"card-glass"}),yt(HP,{class:"card-glass"})])):a.value==="llm"?(ue(),fe("div",XU,[yt(vA)])):a.value==="evolution"?(ue(),fe("div",qU,[yt(_C)])):a.value==="merge"?(ue(),fe("div",YU,[yt(FC,{"memory-id":l.value,"show-close":!!l.value,onClose:w[0]||(w[0]=T=>l.value=null),onNodeClick:A},null,8,["memory-id","show-close"])])):et("",!0)]),yt(Id,{name:"panel-slide"},{default:jc(()=>[f.value?(ue(),fe("div",jU,[(ue(),Zm(m0(h.value),eg(g.value,{onClose:M,onSaved:y,onDeleted:C}),null,16))])):et("",!0)]),_:1})],2)]),yt(Id,{name:"fade"},{default:jc(()=>[c.value?(ue(),fe("div",{key:0,class:"modal-overlay",onClick:L},[v("div",{class:"modal-window card-glass",onClick:w[1]||(w[1]=ja(()=>{},["stop"]))},[v("header",KU,[v("h2",null,te(c.value.title),1),v("button",{class:"close-icon",onClick:L},"×")]),v("div",ZU,[v("div",JU,[w[5]||(w[5]=v("span",{class:"label"},"类型",-1)),v("span",{class:pt(["type-tag",c.value.memory_type])},te(G(c.value.memory_type)),3)]),v("div",QU,[w[6]||(w[6]=v("h3",null,"内容",-1)),v("p",null,te(c.value.content),1)]),v("div",eF,[v("div",tF,[w[7]||(w[7]=v("span",{class:"label"},"范围",-1)),v("span",nF,te(c.value.scope),1)]),v("div",iF,[w[8]||(w[8]=v("span",{class:"label"},"时间",-1)),v("span",sF,te(c.value.timestamp),1)]),v("div",rF,[w[9]||(w[9]=v("span",{class:"label"},"重要性",-1)),v("span",oF,te(c.value.importance),1)])]),v("div",{class:"modal-footer"},[v("button",{class:"secondary-btn",onClick:S},"编辑"),v("button",{class:"primary-btn",onClick:U},"查看合并链")])])])])):et("",!0)]),_:1})]))}}),q_=Nx(aF),lF=Ox();q_.use(lF);q_.mount("#app");
